...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen items-center justify-between w-full h-full p-8 bg-zinc-100/95 dark:bg-zinc-900/90 font-extralight z-10">
      <div className="flex flex-row justify-between w-full items-center ring-1 ring-zinc-700 px-4 py-2 rounded-t-xl rounded-b-sm">
        ...
        <div className="uppercase py-2">01:28 - Wed 7 feb 24</div>
        {/* <ModeToggle /> */}
      </div>
      ...
      >
        ...
        >
          ...
          <p className="max-w-md w-full">
            <img src="https://random.cc0-lib.wtf/api/image" alt="" />
          </p>
      ...
      <div className="flex flex-row justify-between w-full items-center ring-1 ring-zinc-700 px-4 py-2 rounded-b-xl rounded-t-sm">
        ...
        <div className="text-xs">{data.footer.copy}</div>
      </div>
    </main>
  );
}
