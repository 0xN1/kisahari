        ...
        <DialogHeader>
          ...
          >
            <div className="text-start w-full items-start h-auto max-w-prose flex justify-center flex-col gap-2">
              <h3 className="font-light text-sm font-mono uppercase">Title</h3>
              <input
                minLength={2}
                maxLength={50}
              ...
              />
              <h4 className="ml-1 text-xs uppercase text-zinc-600">
                Make it pop
              </h4>
            </div>
            <div className="text-start w-full items-start h-auto max-w-prose flex justify-center flex-col gap-2">
            ...
            <div className="flex gap-8 w-full justify-end items-center relative">
              <div className="flex gap-2">
                <button
                  type="reset"
                  className="px-4 py-2 text-zinc-400 hover:text-lime-300 rounded-md"
                >
                  <RotateCcw className="w-4 h-4" />
                </button>
                <button
                  className="px-4 py-2 text-sm hover:bg-lime-500 text-zinc-200 ring-1 ring-zinc-300 rounded-sm hover:text-zinc-800 uppercase"
                  type="submit"
                >
                  Submit
                </button>
